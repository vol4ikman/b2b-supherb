...
!(function (e, t) {
	...
	const t = (e) => {
		...
		D = (e, t, i) => {
			if (
				...
				if (
					"string" != typeof t.customClass[i] &&
					!t.customClass[i].forEach
				)
					return void s(
					...
					if ("MutationObserver" in window) {
						...
						new MutationObserver(() => {
							const n =
								...
								((o = e),
								parseInt(
									window.getComputedStyle(o).marginLeft
								) +
									parseInt(
		...
		Te = (e) => {
			...
			return (
				...
				e.progressStepsDistance &&
					_(t, "width", e.progressStepsDistance),
				t
			);
		},
		Se = (t, i) => {
	...
	const lt = {
		...
		ft = (e) => {
			dt.includes(e) &&
				s(`The parameter "${e}" is incompatible with toasts`);
		},
		bt = (e) => {
			gt(e) && l(e, gt(e));
		};
	...
	class yn {
		...
		_main(t) {
			...
			((e) => {
				...
				Q.currentInstance &&
					(Q.currentInstance._destroy(), O() && We()),
