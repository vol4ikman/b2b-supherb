...
$submit_button_title      = get_field( 'submit_button_title' );
$register_now_text        = get_field( 'register_now_text' );
?>

<main class="main-login-screen" data-screen="1">
	<div class="login-screen-inner">
		<div class="login-sidebar">
			...
			<div class="form-wrapper">
				...
				<form class="step1-form" method="post" autocomplete="off">
					<label>
						<input type="tel" name="phone" placeholder="<?php echo esc_html( $phone_number_placeholder ); ?>"
							autocomplete="off"
